/// English meanings of the 114 surah names, keyed by surah id (matches
/// `surahs.id` in the DB). Sourced from the quran.com API
/// (api.quran.com/api/v4/chapters?language=en, `translated_name.name`),
/// the same authoritative source used on quran.com's own chapter pages.
/// Static/curated — not sourced from our own DB — so it's bundled here
/// rather than added as a DB column.
const Map<int, String> surahMeanings = {
  1: 'The Opener',
  2: 'The Cow',
  3: 'Family of Imran',
  4: 'The Women',
