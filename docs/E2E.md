...
iOS bundle are both `com.almarfa.alquran` (in the `patrol:` block). Note the
androidTest class below stays under the Kotlin `namespace` package
`com/almarfa/al_quran/` — that's intentional and unrelated to the published id.
