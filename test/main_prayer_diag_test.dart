...
// (incl. the gold forbidden pill + sheet prohibited-time marks) without
// throwing, so `make diag-prayer` won't white-screen.
void main() {
  testWidgets('PrayerDiagApp renders all states', (tester) async {
    ...
    expect(find.textContaining('Before Maghrib'), findsWidgets); // sheet marks
